...
GitDocket 0.4.0 supports npm as an alternative to [Homebrew](homebrew.md). Node 22 or later and npm are required. CLI/MCP commands use standalone binaries and need no separate Bun installation. Earlier 0.3.1 commands and the core/web library packages remain Bun-dependent.
