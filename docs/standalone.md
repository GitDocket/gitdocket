...
GitDocket 0.6.0 distributes standalone CLI and MCP executables through [Homebrew](homebrew.md) and [npm](npm.md). This page describes their build and qualification process; ordinary installation does not require the build tools.
