...
Run `docket --version`, then `docket init --agent claude --agent codex` inside your project. See [Getting started](https://github.com/GitDocket/gitdocket/blob/main/docs/getting-started.md) and [npm installation and migration](https://github.com/GitDocket/gitdocket/blob/main/docs/npm.md). Project instruction upgrades remain an explicit `docket upgrade` operation.
